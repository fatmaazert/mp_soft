...
function AllRegles() {
  ...
  const handleSubmitSelectedUsers = async (user) => {
    console.log({ user });
  };
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-end gap-5 mt-6 max-w-7xl mx-auto">
        ...
        {
          // show [Add | update | delete] btns
          // if selectedRegle is null => show [Add] btn
          // if selectedRegle is not null => show [update | delete] btns
          selectedRegle && (
            <>
              <button
